...
public class ChunkMeshController : MonoBehaviour
{
    ...
    public void UpdateAudioData(float data)
    {
        ...
        {
            field.offset = new Vector3(data, -data, data*Random.Range(-1,1));
        }
    }
    ...
    {
        BuildMesh();
        GetComponent<MeshRenderer>().material.SetFloat("_offsetX", fields[0].offset.x);
        GetComponent<MeshRenderer>().material.SetFloat("_offsetY", fields[0].offset.y);
        GetComponent<MeshRenderer>().material.SetFloat("_offsetZ", fields[0].offset.z);
    }
    ...
    void BuildMesh(){
        ...
        //AddCube(new Vector3(0,0,0), verts, tris, norms, uvs);
