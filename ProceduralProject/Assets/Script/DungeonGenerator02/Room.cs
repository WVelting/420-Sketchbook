...
public class Room : MonoBehaviour
{
    ...
    public void InitRoom(RoomType type){
        ...
        Vector3 posN = new Vector3(0, -.25f, +dis) + transform.position;
        Vector3 posS = new Vector3(0, -.25f, -dis) + transform.position;
        Vector3 posE = new Vector3(+dis, -.25f,0) + transform.position;
        Vector3 posW = new Vector3(-dis, -.25f,0) + transform.position;
